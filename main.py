...
def recupereCommandes():
    ...
    if responseCommandes.status_code == 200:
        ...
        print(f"Erreur HTTP {responseCommandes.status_code}: {responseCommandes.text}")
...
@app.post('/documents/{site}{numDossierRdt}{siteImport}{numDossierRdtImport}')
